...
public class WordCounter  {
    public static Map<String, Integer> calculatedWord() {
        ...
        String text = "When the offensive resumed, the Turks received their first victory when the Greeks " +
                ...
                "Ankara and Istanbul were represented, but Greece refused.\" " +
                "+ \" With the conclusion of the Southern and Eastern fronts, " +
                "Ankara was able to concentrate more forces on the West against the Greeks.\" " +
                "+ \" They also began to receive support from Soviet Union, as well as France and Italy, " +
                ...
                "+ \" The decision was made in the Greek military command to march on the nationalist " +
                "capital of Ankara to force Mustafa Kemal to the negotiating table.\" " +
                "+ \" For 21 days, the Turks and Greeks fought a pitched battle at the Sakarya river," +
                " which ended in Greek withdrawal.\" " +
                "+ \" Almost of year of stalemate without much fighting followed," +
